...
int main() {
    ...
    cout << "Результат для одномерного массива: ";
    print1DArray(arr1D);

    // Обработка и вывод двумерного массива
    process2DArray(arr2D, a, b);
    cout << "Результат для двумерного массива: " << endl;
    print2DArray(arr2D);

    // Повторный вывод результатов
    cout << "Повторный вывод результата для одномерного массива: ";
    print1DArray(arr1D);

    cout << "Повторный вывод результата для двумерного массива: " << endl;
    print2DArray(arr2D);
